...
if __name__ == "__main__":
    ...
    traindata = pd.read_csv('/home/dahan/python_datamining/data/u1.base',sep='\t', header=None,index_col=None)
    testdata = pd.read_csv('/home/dahan/python_datamining/data/u1.test',sep='\t', header=None,index_col=None)
    #删除时间标签列
